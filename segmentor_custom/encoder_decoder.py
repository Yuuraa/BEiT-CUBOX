...
class EncoderDecoderAP(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(EncoderDecoderAP, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(EncoderDecoderAP, self).init_weights(pretrained)
    ...
    def forward(self, img, img_metas, return_loss=True, return_logits=False, **kwargs):
        if return_loss:
            ...
            return self.simple_logits(img[0], img_metas[0], **kwargs)
        else:
