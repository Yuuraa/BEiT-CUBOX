...
class PrintEncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(PrintEncoderDecoder, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(PrintEncoderDecoder, self).init_weights(pretrained)
    ...
    def encode_decode(self, img, img_metas):
        ...
        x, attn_map = self.extract_feat(img)
